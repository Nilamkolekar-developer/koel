...
class AppPreferences {
  ...
  /// Saves a string value for a specific key
...
// ================= INT =================
  ...
  /// Sets the general 'token' string
  static Future<void> setToken(String value) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString(_tokenKey, value);
  }

  /// Gets the general 'token' string
  static Future<String?> getToken() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString(_tokenKey);
  }

  /// Removes the general 'token' string
  ...
  /// Sets Master Login User ID and Role
  static Future<void> setMasterLoginData(String userId, String role) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString(_masterLoginUserByKey, userId);
    await prefs.setString(_masterLoginRoleByKey, role);
  }

  /// Gets Master Login User ID
  static Future<String?> getMasterLoginUserBY() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString(_masterLoginUserByKey);
  }

  /// Gets Master Login User Role
  ...
  /// Specifically clears login session data for logout
  static Future<void> clearLoginSession() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.remove(_tokenKey);
    await prefs.remove(_masterLoginUserByKey);
    await prefs.remove(_masterLoginRoleByKey);
    // Also clear tokens from the saveTokens method
  ...
  /// Fully clears everything
  static Future<void> clearAll() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.clear();
    print("🧹 All preferences wiped");
  }
}
