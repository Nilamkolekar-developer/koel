...
// }
// ===============================
// SAFE JSON CONVERTER (USE EVERYWHERE)
// ===============================
class J {
  static String? s(dynamic v) => v?.toString();
...
class VariantModel {
  ...
  factory VariantModel.fromJson(Map<String, dynamic> json) {
    return VariantModel(
      count: J.i(json['count']),
      next: json['next'],
      previous: json['previous'],
      message: J.s(json['message']),
...
class Variant {
  ...
  factory Variant.fromJson(Map<String, dynamic> json) {
    return Variant(
      id: J.i(json['id']),
      variantCode: J.s(json['variant_code']),
      description: J.s(json['description']),
      oem: J.i(json['oem']),
      vinNo: J.s(json['vin_no']),
      isActive: J.s(json['is_active']),
      vehicleModel: J.s(json['vehicle_model']),
      modelId: J.i(json['model_id']),
      subModel: json['sub_model'] != null
          ? VariantSubModel.fromJson(json['sub_model'])
          : null,
      sModelId: J.i(json['s_model_id']),
      modelYear: J.s(json['model_year']),
      mYearId: J.i(json['m_year_id']),
      noOfInjectors: J.s(json['no_of_injectors']),
      firingSequence: J.s(json['firing_sequence']),
      noOfFip: J.s(json['no_of_fip']),
      typeName: J.s(json['type_name']),
      applicationName: J.s(json['application_name']),
      type: J.s(json['type']),
      rating: J.s(json['rating']),
      assemblyNo: J.s(json['assembly_no']),
      rpm: J.s(json['rpm']),
      application: J.i(json['application']),
      calibration: J.s(json['calibration']),
      vinDecodings: json['vin_decodings'] != null
          ? List<dynamic>.from(json['vin_decodings'])
          : null,
      variantPart: (json['variant_part'] as List?)
          ?.map((e) => VariantPart.fromJson(e))
          .toList(),
      variantEcu: (json['variant_ecu'] as List?)
          ?.map((e) => VariantEcuEcu.fromJson(e))
          .toList(),
      workshop: (json['workshop'] as List?)
          ?.map((e) => VariantWorkshop.fromJson(e))
          .toList(),
      workshopGroup: (json['workshop_group'] as List?)
          ?.map((e) => VariantWorkshopGroup.fromJson(e))
          .toList(),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
        ...
        "calibration": calibration,
        "vin_decodings": vinDecodings,
        "variant_part": variantPart?.map((e) => e.toJson()).toList(),
        "variant_ecu": variantEcu?.map((e) => e.toJson()).toList(),
        "workshop": workshop?.map((e) => e.toJson()).toList(),
        "workshop_group": workshopGroup?.map((e) => e.toJson()).toList(),
      };
}

// ===============================
// SUB MODELS (SAFE PATTERN APPLIED)
// ===============================
class VariantSubModel {
  int? id;
  String? name;
  ...
  VariantSubModel({this.id, this.name, this.modelYear, this.ecus});
...
// ===============================
// ECU + OTHER MODELS (SAFE)
// ===============================
class VariantEcus {
  int? id;
  String? name;

  VariantEcus({this.id, this.name});
  ...
  factory VariantEcuEcu.fromJson(Map<String, dynamic> json) {
    return VariantEcuEcu(
      ...
      productionSwId: json['production_sw_id'] != null
          ? ProductionSwId.fromJson(json['production_sw_id'])
          : null,
      isLatest: J.b(json['is_latest']),
      isActive: J.b(json['is_active']),
    );
  }
...
class ProductionSwId {
  ...
  factory ProductionSwId.fromJson(Map<String, dynamic> json) {
    return ProductionSwId(
      id: J.i(json['id']),
      swPartNo: J.s(json['sw_part_no']),
      dataFile: J.s(json['data_file']),
      hexSrecFile: J.s(json['hex_srec_file']),
      description: J.s(json['description']),
    );
  }
...
class VariantWorkshop {
  ...
  VariantWorkshop({this.id, this.name});
...
class VariantWorkshopGroup {
  ...
  VariantWorkshopGroup({this.id, this.groupName});

  factory VariantWorkshopGroup.fromJson(Map<String, dynamic> json) {
    return VariantWorkshopGroup(
      id: J.i(json['id']),
      groupName: J.s(json['group_name']),
    );
  }
...
class VariantPart {
  ...
  factory VariantPart.fromJson(Map<String, dynamic> json) {
    return VariantPart(
      id: J.i(json['id']),
      ecuId: J.i(json['ecu_id']),
      partNo: J.s(json['part_no']),
      description: J.s(json['description']),
      partCategory: J.s(json['part_category']),
      position: J.s(json['position']),
      isActive: J.b(json['is_active']),
      slNumber: J.s(json['sl_number']),
      comment: J.s(json['comment']),
    );
  }
