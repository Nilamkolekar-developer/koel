...
class PidCode {
  ...
  factory PidCode.fromJson(Map<String, dynamic> json) {
    return PidCode(
      ...
      access: json['access'],
      piCodeVariable: json['pi_code_variable'] != null
          ? (json['pi_code_variable'] as List)
              .map((e) => PiCodeVariable.fromJson(e))
              .toList()
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'Header': header,
      'access': access,
      'pi_code_variable': piCodeVariable?.map((e) => e.toJson()).toList(),
    };
  }
}
...
class PiCodeVariable {
  ...
  String? endian;
  String? numType;
  List<PidVariableGroup>? group;
  List<Message>? messages;
  Message? selectedEnum;
  String? showResolution;
  double? stepperValue;
  double? userValue;
  String? writeValue;
  ...
  factory PiCodeVariable.fromJson(Map<String, dynamic> json) {
    return PiCodeVariable(
      id: json['id'],
      dav: json['dav'] != null ? (json['dav'] as num).toDouble() : null,
      shortName: json['short_name'],
      index: json['index'],
      selected: json['Selected'] ?? false,
      parameterName: json['parameter_name'] ?? "",
      ...
      resolution: json['resolution'] != null
          ...
          : null,
      offset:
          json['offset'] != null ? (json['offset'] as num).toDouble() : null,
      ...
      group: json['group'] != null
          ? (json['group'] as List)
              .map((e) => PidVariableGroup.fromJson(e))
              .toList()
          : null,
      messages: json['messages'] != null
          ? (json['messages'] as List).map((e) => Message.fromJson(e)).toList()
          : null,
      selectedEnum: json['SelectedEnum'] != null
          ? Message.fromJson(json['SelectedEnum'])
          : null,
      showResolution: json['show_resolution'],
      stepperValue: json['stepper_value'] != null
          ? (json['stepper_value'] as num).toDouble()
          : null,
      userValue: json['user_value'] != null
          ? (json['user_value'] as num).toDouble()
          : null,
      writeValue: json['write_value'],
      actuatorWriteValue: json['actuator_write_value'],
      minVal: json['min_val'] ?? "",
      maxVal: json['max_val'] ?? "",
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'SelectedEnum': selectedEnum?.toJson(),
      'show_resolution': showResolution,
      'stepper_value': stepperValue,
      'user_value': userValue,
      'write_value': writeValue,
...
class PidVariableGroup {
  ...
  factory PidVariableGroup.fromJson(Map<String, dynamic> json) {
    return PidVariableGroup(
      id: json['id'],
      name: json['name'],
    );
  }
  ...
  factory EcuModel.fromJson(Map<String, dynamic> json) {
    return EcuModel(
      ...
      pidList: json['pid_list'] != null
          ? (json['pid_list'] as List).map((e) => PidCode.fromJson(e)).toList()
          : [],
      txHeader: json['tx_header'],
      rxHeader: json['rx_header'],
      protocol:
          json['protocol'] != null ? Protocol.fromJson(json['protocol']) : null,
      pidByAddrSeq: json['PidByAddrSeq'],
    );
  }
...
class PidModel {
  ...
  factory PidModel.fromJson(Map<String, dynamic> json) {
    return PidModel(
      ...
      results: json['results'] != null
          ? (json['results'] as List).map((i) => PidResult.fromJson(i)).toList()
          : null,
    );
  }
...
class ReadParameterPid {
  ...
  ReadParameterPid({
    ...
    this.showResolution,
    this.messages,
    required List<PidVariable> variables,
  });
...
class PidGroupModel {
  ...
  factory PidGroupModel.fromJson(Map<String, dynamic> json) {
    return PidGroupModel(
      id: json['id'],
...
class WriteParameterPid {
  ...
  factory WriteParameterPid.fromJson(Map<String, dynamic> json) {
    return WriteParameterPid(
        ...
        unit: json['unit'],
        pidName: json['pidName'],
        memory_address: json['memory_address']);
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'frame_of_pid_message':
          frameOfPidMessage?.map((v) => v.toJson()).toList(),
      'Selected': selected,
      'FramID': framId,
      'endian': endian,
      'num_type': numType,
