        ...
        actions: [
          Padding(
            ...
            child: ConstrainedBox(
              ...
              child: Image.asset('assets/new/ic_ikonnect.jpg', fit: BoxFit.contain),
            ),
          ),
        ],
      ),
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () => _showCloseDialog(data['title']!),
                ),
              ],
            ),
          ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          SizedBox(
            width: 100,
            child: Text("$label:", style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF309F93))),
          ),
